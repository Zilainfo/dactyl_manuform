...
combo_t key_combos[] = {
    ...
    //COMBO(digits_layer_combo, TG(_DIGITS)),
...
enum {
    ...
    TD_KC_BRACKET,
    TD_KC_PAREN
    // TD_KC_SLASH_KC_BACKSLASH
    // TD_KC_AMPERSAND_KC_PIPE
};
...
tap_dance_action_t tap_dance_actions[] = {
  ...
  //   [TD_KC_SLASH_KC_BACKSLASH] = ACTION_TAP_DANCE_DOUBLE(KC_SLASH, KC_BACKSLASH),
  //  [TD_KC_AMPERSAND_KC_PIPE] = ACTION_TAP_DANCE_DOUBLE(KC_AMPERSAND, KC_PIPE)
};
...
*/
        ...
        KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                                      KC_CIRC, KC_AMPR, KC_ASTR, KC_QUES, DIGITS,
                 KC_F11,  KC_F12,                                                                           _______, _______,
                                   _______, _______,                                      _______, _______,
                                                     ...
                                                     _______,_______, _______,  _______),
    // [_DIGITS] = LAYOUT(
    //     KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,234921349088999                                        KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,
    //     KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    //     KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                                      KC_CIRC, KC_AMPR, KC_ASTR, KC_QUES, DIGITS,
    //              KC_F11,  KC_F12,                                                                           _______, _______,
    //                                _______, _______,                                      _______, _______,
  ...
  //         KC_INSERT, _______, _______, _______, _______,                         _______, KC_COLN, _______, _______, PROG,
  //                   _______, _______,                                                   _______, _______,
